...
Via the console, the user can define a grid of dynamic size and select a series of cells to place anywhere on the board and begin, wherein the game will update every tick autonomously. 
