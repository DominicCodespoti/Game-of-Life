...
public class Board {
    ...
    public Integer checkSurrounding(int X, int Y)
    {
        ...
        try {
            ...
            if (boardSpaces.get(boardSpaces.get(X).size() - 1).get(Y).isCellAlive() == true)
            {
                total += 1;
            }
        }
        ...
        try {
            ...
            catch (Exception ex)
            {
                ...
                {
                    if (boardSpaces.get(boardSpaces.get(X).size() - 1).get(0).isCellAlive() == true)
                    {
                        total += 1;
                    }
                }
        ...
        try {
            ...
            catch (Exception ex)
            {
                ...
                {
                    if (boardSpaces.get(boardSpaces.get(X).size() - 1).get(boardSpaces.size() - 1).isCellAlive() == true)
                    {
                        total += 1;
                    }
                }
